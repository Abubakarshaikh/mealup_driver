  ...
  void checkforpermission() async {
    ...
    if (_permissionGranted == PermissionStatus.denied) {
      ...
      if (_permissionGranted != PermissionStatus.granted) {
        Constants.currentlatlong1().then((value) {
          print("origin123:$value");
          current_lat = value!.latitude;
          current_long = value.longitude;
          Constants.CheckNetwork().whenComplete(() => startTime());
        });
        return;
      }
    }else{
    ...
    if (mounted) {
      RestClient(ApiHeader().dioData()).orderStatusChange1(id, "ACCEPT").then((response) {
        ...
        if (sucess = true) {
          ...
          PreferenceUtils.setString(Constants.previos_order_vendor_name, vendor_name!);
          ...
          PreferenceUtils.setString(Constants.previos_order_vendor_lat, vendor_lat!);
          PreferenceUtils.setString(Constants.previos_order_vendor_lang, vendor_lang!);
          PreferenceUtils.setString(Constants.previos_order_user_lat, user_lat!);
          PreferenceUtils.setString(Constants.previos_order_user_lang, user_lang!);
          PreferenceUtils.setString(Constants.previos_order_user_address, user_address!);
          PreferenceUtils.setString(Constants.previos_order_vendor_image, vendor_image!);
          PreferenceUtils.setString(Constants.previos_order_user_name, user_name!);
                                ...
                                Visibility(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      double user_lat =
                                          double.parse(orderdatalist[index].userAddress!.lat!);
                                      double user_long =
                                          double.parse(orderdatalist[index].userAddress!.lang!);

                                      double vendorLat =
                                      double.parse(orderdatalist[index].vendor!.lat!);
                                      double vendorLong =
                                      double.parse(orderdatalist[index].vendor!.lang!);
                                      ...
                                      String str = Constants.calculateDistance(
                                          vendorLat, vendorLong, user_lat, user_long)
                                          .toString();
                                                ...
                                                child: RichText(
                                                  ...
                                                  text: TextSpan(
                                                    children: [
                                                      TextSpan(
                                                          text:
                                                              Languages.of(context)!.reconnectlable,
                                                          style: TextStyle(
                                                            color: Constants.color_theme,
                                                            fontSize: 16,
                                                            fontFamily: Constants.app_font_bold,
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          if (_cancelReason == "0") {
                            ...
                            // Constants.createSnackBar("Select Cancel Reason", context, Constants.color_red);
                            ...
                            if (_text_cancel_reason_controller.text.length == 0) {
                              ...
                              // Constants.createSnackBar("Add Reason", context, Constants.color_red);
                            } else {

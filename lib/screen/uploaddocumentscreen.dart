                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: AppLableWidget(
                                      title: Languages.of(context)!.vehicletypelable,
                                    ),
                                  ),
                                  Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: DropdownButtonHideUnderline(
                                          child: new DropdownButton<String>(
                                              hint: Text(
                                                Languages.of(context)!.selectvehicletypelable,
                                                style: TextStyle(
                                  ...
                                  Container(
                                    ...
                                    alignment: Alignment.topLeft,
                                    child: AppLableWidget(
                                      title: Languages.of(context)!.vehiclenumberlable,
                                    ),
                                  ),
                                  Container(
                                    margin: EdgeInsets.only(left: 10, right: 10),
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: Constants.kTextFieldInputDecoration.copyWith(
                                              hintText:
                                                  Languages.of(context)!.entervehiclenumberlable),
                                        ),
                                      ),
                                    ),
                                  ),
                                  Container(
                                    ...
                                    alignment: Alignment.topLeft,
                                    child: AppLableWidget(
                                      title: Languages.of(context)!.licencenumberlable,
                                    ),
                                  ),
                                  Container(
                                    margin: EdgeInsets.only(left: 10, right: 10),
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: Constants.kTextFieldInputDecoration.copyWith(
                                              hintText:
                                                  Languages.of(context)!.enterlicencenumberlable),
                                        ),
                                      ),
                                    ),
                                  ),
                                  Container(
                                    ...
                                    alignment: Alignment.topLeft,
                                    child: AppLableWidget(
                                      title: Languages.of(context)!.uploadyourdrivinglicencelable,
                                    ),
                                  ),
                                  Padding(
                                  ...
                                  Container(
                                    ...
                                    alignment: Alignment.topLeft,
                                    child: AppLableWidget(
                                      title: Languages.of(context)!.uploadoneofnatinallable,
                                    ),
                                  ),
                                  Padding(
                                    padding: EdgeInsets.all(ScreenUtil().setWidth(8)),
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        margin:
                                            EdgeInsets.only(top: 0, right: 5, bottom: 0, left: 5),
                                        decoration: BoxDecoration(
                                            color: Constants.itembgcolor,
                                            border: Border.all(
                                              color: Constants.itembgcolor,
                                  ...
                                  Container(
                                    ...
                                    alignment: Alignment.topLeft,
                                    child: Text(
                                      Languages.of(context)!.selectanyofthemlable,
                                      style: TextStyle(
                                          color: Constants.whitetext,
                                          fontFamily: Constants.app_font,
                                          fontSize: 11),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            Languages.of(context)!.voteridcardlable,
                                            style: TextStyle(
                                                color: Constants.greaytext,
                                                fontFamily: Constants.app_font,
                                                fontSize: 11),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          margin: EdgeInsets.only(left: 10),
                                          child: Text(
                                            Languages.of(context)!.nationalidcardlable,
                                            style: TextStyle(
                                                color: Constants.greaytext,
                                                fontFamily: Constants.app_font,
                                                fontSize: 11),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          margin: EdgeInsets.only(left: 10),
                                          child: Text(
                                            Languages.of(context)!.aadharcardlable,
                                            style: TextStyle(
                                                color: Constants.greaytext,
                                                fontFamily: Constants.app_font,
                                                fontSize: 11),
                          ...
                          onTap: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              if (_Licenceimage == null) {
                                Constants.createSnackBar(Languages.of(context)!.selectlicencelable,
                                    this.context, Constants.color_red);
                              } else if (_NationalIdImage == null) {
                                Constants.createSnackBar(
                                    Languages.of(context)!.selectnastionalidlable,
                                    this.context,
                                    Constants.color_red);
                              } else {
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          // Container(
                          //
                          //   child: Text("Your document file must be in .jpeg, .png or .pdf format.",style:TextStyle(color: Constants.whitetext,fontSize: 14,fontFamily: Constants.app_font),),
                          //
                          // ),
                          ...
                          Container(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  WidgetSpan(
                                    child: Text(Languages.of(context)!.yourfiletypelable,
                                        style: TextStyle(
                                            color: Constants.whitetext,
                                            fontSize: 13,
                                            fontFamily: Constants.app_font)),
                                  ...
                                  //     margin: EdgeInsets.only(left: 0,top: 0,bottom: 0,right: 5),
                                  //
                                  //     child: Text("or", style: TextStyle(color: Constants.whitetext, fontSize:13, fontFamily: Constants.app_font,),),),
                                  //
                                  //
                                  // ),
                                  ...
                                  //     margin: EdgeInsets.only(left: 0,top: 0,bottom: 0,right: 5),
                                  //
                                  //     child: Text(" .pdf", style: TextStyle(color: Constants.color_theme, fontSize:13, fontFamily: Constants.app_font,),),),
                                  //
                                  //
                                  // ),
                    ...
                    Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(left: 10),
                            child: Text(Languages.of(context)!.makesurefilelable,
                                style: TextStyle(
                                    color: Constants.whitetext,
                                    fontSize: 13,
                                    fontFamily: Constants.app_font)),

...
print('====== ${PreferenceUtils.getString(Constants.driverdevicetoken)}');
  ...
  void callApiForsetting() {
    ...
    RestClient(ApiHeader().dioData()).driverSetting().then((response) {
      ...
      //  PreferenceUtils.setString(Constants.is_driver_accept_multipleorder, response.data!.isDriverAcceptMultipleorder.toString());
      //  PreferenceUtils.setString(Constants.driver_accept_multiple_order_count, response.data!.driverAcceptMultipleOrderCount.toString());
